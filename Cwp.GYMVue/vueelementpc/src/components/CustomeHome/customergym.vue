        ...
        <div class="customergymcoursediv">
          <el-row>
            ...
            <el-col :span="10" style="color:green;text-align:right">
              <span @click="joincouse(item)">报名</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="2">&nbsp;</el-col>
  ...
  methods: {
    ...
    joincouse(value) {
      ...
      this.$axios
        ...
        .catch(err => {});
      this.customercourse.courseid = value.id;
      this.customercourse.coursename = value.coursename;
      this.customercourse.customerid = this.customerdata.id;
      this.customercourse.customername = this.customerdata.name;
      var url2 = "/api/customer_course/CreateData";
      this.$axios
        .post(url2, that.customercourse)
        .then(resp => {
          that.getLoad();
          that.getgymcourse();
        })
