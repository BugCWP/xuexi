      ...
      <el-row>
        <el-col :span="24">
          ...
          >
            ...
            <el-table-column prop="cityname" label="上级市" width="500"></el-table-column>
          </el-table>
        </el-col>
      </el-row>
      <el-row>
...
export default {
  ...
  methods: {
    ...
    loadData() {
      var url = "http://localhost:50379/api/area/GetDataList?pageIndex="+this.pageIndex+"&pageSize="+this.pageSize+"&search";
      this.$axios
        .get(url)
        .then(resp=>{
